            ...
            <div class="col-md-12">
                <div class="card card-user">
                    <form class="" action="<?php echo base_url(); ?>procedure_reurb/update_procedure/<?php echo $process_number->id; ?>" method="post">
                        <input type="hidden" name="register_procedure_reurb" value="1">
                        <div class="card-header">
                            <div class="row">
                                <div class="col-md-12">
                                    <h5 class="card-title d-inline">Detalhe do Cadastro de procedimentos de REURB</h5>
                                    <div class="d-flex justify-content-end float-right">
                                        <a href="<?php echo base_url() ?>register_procedure_reurb/registers" class="btn btn-secundary mr-1 float-md-right float-sm-right float-xs-right">Voltar</a>
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="row">
                                        <div class="col-md-12">
                                            <?php if (!empty($process_number->update_for)) : ?>
                                                <p class="font-weight-bold">
                                                    Última vez alterado por: 
                                                    <span class="font-weight-normal">
                                                        <?php echo $process_number->user_name; ?>
                                                    </span>
                                                </p>
                                            <?php endif; ?>
                                        </div>
                                    ...
                                    <div class="tab-content">
                                        <div id="dados" class="tab-pane active py-2">
                                            ...
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        <label for="">Descrião do perímetro: </label>
                                                        <textarea name="description" id="" cols="30" rows="80"
                                                                  class="form-control"><?php echo $process_number->perimeter_description; ?></textarea>
                                                    </div>
                                                </div>
                                            </div>
        ...
        <div class="modal-content">
            ...
            <form action="<?php echo base_url(); ?>procedure_reurb/update_registration" method="post" enctype="multipart/form-data">
                ...
                <div class="modal-footer">
                    ...
                    <input type="hidden" name="id_registration" id="id_registration" value="">
                    <input type="hidden" name="id_procedure" value="<?php echo $process_number->id; ?>">
                    <button type="submit" name="update_registration" class="btn btn-primary">Adicionar</button>
                </div>
            </form>
        </div>
    </div>
                ...
                <div class="modal-body">
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <input type="file" name="initiating_decision" value="" id="initiating_decision" accept="application/pdf">
                        </div>
                    </div>
                </div>
                <div class="modal-footer">
                ...
                <div class="modal-body">
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <input type="file" name="completion_decision" value="" id="completion_decision" accept="application/pdf">
                        </div>
                    </div>
                </div>
                <div class="modal-footer">
                ...
                <div class="modal-body">
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <input type="file" name="file_crf" value="" id="file_crf" accept="application/pdf">
                        </div>
                    </div>
                </div>
                <div class="modal-footer">
