          ...
          <div class="row">
            <div class="col-md-12">
              <div class="card-header">
                ...
                <button type="submit" name="update_requester"
                  class="btn btn-round btn-primary float-md-right float-sm-right float-xs-right">Detalhes</button>
                <h2 class="card-title">Detalhe de Títulos e documentos</h2>
                <hr>
              </div>
              <form
                    ...
                    <div class="col-md-4 pl-md-1 pr-md-1">
                      <div class="form-group">
                        ...
                        <input type="text" name="neighbourhood_registry" id="neighbourhood_registry"
                          class="form-control" value="<?php echo $notary_office->neighborhood; ?>">
                      </div>
                    </div>
