        ...
        <div class="card">
          <div class="card-header">
            <a href="<?php echo base_url()?>property_registration"
              class="btn btn-secundary float-right btn-round">Voltar</a>
            <h2 class="card-title">Cadastro de Cartórios de Registro de Imóveis</h2>
            <hr>
          </div>
          <form action="<?php echo base_url(); ?>property_registration/register_property" method="post">
            <div class="card-body">
              <div class="col-md-12">
                <div class="row">
                  ...
                  <div class="col-md-3 pl-md-1 pr-md-1">
                    <div class="form-group">
                      ...
                      <select class="custom-select" id="public_place_type_registry" name="public_place_type_registry">
                        ...
                        <option value="Aeroporto">Aeoroporto</option>
                ...
                <div class="row">
                  ...
                  <div class="col-md-3 pr-md-1 pl-md-1">
                    <div class="form-group">
                      ...
                      <input type="text" name="country_registry" id="country_registry" class="form-control cidade"
