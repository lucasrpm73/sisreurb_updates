...
<table style="width:100%; border: 1px solid white; border-collapse: collapse;">
    ...
    <tr style="border-left: 1px solid black; border-right: 1px solid black; border-collapse: collapse;">
        <td style="border-left: 1px solid black; border-right: 1px solid black; font-size:small" colspan="6">
            <p><b>Oliria Araújo,</b> Nacionaliadade Brasileira, Divorciada, Aposentada, inscrito(a) no CPF sob o n° 488.717.291-53, e C.I/R.G n° MG-17-272.875 , Órgão Exp. PC-MG filho(a) de Ana Fiora De Araújo e Valentim José De Araújo, residente(s) e domiciliado(s) na Rua Joao Junior De Sá, n° 33, Bairro Centro, Montezuma-MG</p>
        </td>
    <tr>
    <tr style="border-left: 1px solid black; border-right: 1px solid black; border-collapse: collapse;">
        <td style="font-size:small" colspan="6">
